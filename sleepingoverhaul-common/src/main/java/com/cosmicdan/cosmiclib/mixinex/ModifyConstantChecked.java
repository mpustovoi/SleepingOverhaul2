...
/**
 * Identical to {@link org.spongepowered.asm.mixin.injection.ModifyConstant} but with extra "onFail"
 * argument, which will be called on injection failure if set.
 *
 * @author Daniel 'CosmicDan' Connolly
 */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
public @interface ModifyConstantChecked {
     ...
     * to <code>true</code> and defaults to 1. Use this option during debugging to
     ...
     * setting this value to <code>4</code>.
     *
     ...
     * argument such that if <code>allow</code> is less than <code>require</code> the
     * value of <code>require</code> is always used.</p>
     *
    ...
    Class<?> onFailure() default Void.class;
}
